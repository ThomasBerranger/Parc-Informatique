...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'oc_platforme.antispam' => 'getOcPlatforme_AntispamService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('lzvbPAX3Sy', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5lw0QcYTc-', 0, 'ZWdP32RQO5W16fM2cPjzsA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1CmnJYl3zM', 0, 'ZWdP32RQO5W16fM2cPjzsA', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UB8T8QOTqZ', 0, 'ZWdP32RQO5W16fM2cPjzsA', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'tatiana.inow.fr', 'port' => 3306, 'dbname' => 'administrateurs', 'user' => 'administrateurs', 'password' => 'cEmFa', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\OC\\PlatformeBundle\\Entity'))), 'OC\\PlatformeBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('OCPlatformeBundle' => 'OC\\PlatformeBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_830997381af03a2d3ba43f0e6726e83251275639a3f6dd0817349d5036d7cd42');
    ...
    /**
     * Gets the 'oc_platforme.antispam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformeBundle\Antispam\OCAntispam A OC\PlatformeBundle\Antispam\OCAntispam instance
     */
    protected function getOcPlatforme_AntispamService()
    {
        return $this->services['oc_platforme.antispam'] = new \OC\PlatformeBundle\Antispam\OCAntispam();
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('webmaster', 'Administrateurs');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\OC\\PlatformeBundle/Resources/views'), 'OCPlatforme');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('acd291a6b9d8e9f62f038423a3a4784e1436737a');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5831ed50c048d6.85101753')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'OCPlatformeBundle' => 'OC\\PlatformeBundle\\OCPlatformeBundle',
            ...
            'database_host' => 'tatiana.inow.fr',
            'database_port' => 3306,
            'database_name' => 'administrateurs',
            'database_user' => 'administrateurs',
            'database_password' => 'cEmFa',
            'mailer_transport' => 'smtp',
            'mailer_host' => NULL,
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'acd291a6b9d8e9f62f038423a3a4784e1436737a',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'acd291a6b9d8e9f62f038423a3a4784e1436737a',
